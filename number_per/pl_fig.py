...
data1 = np.loadtxt('rerecenter10_t10000_nbest500.dat')
data2 = np.loadtxt('rerecenter5_t10000_nbest500.dat')
...
axe.plot(l2, p2, 'o', markersize=2, c='black', label = r'$100$')#'$k_{on}^{c}=2,k_{off}=0.2$')
#axe.plot(l2, p2, 's', markersize=2, c='mediumblue', label = r'$25$')#'$k_{on}^{c}=5,k_{off}=0.2$')
...
#fig.savefig("entropy_5_n500.png")
plt.show()
