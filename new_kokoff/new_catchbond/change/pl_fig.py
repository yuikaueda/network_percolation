...
data1 = np.loadtxt('s_change_kcon_20_030_ss_150.dat')
data2 = np.loadtxt('s_change_kcon_20_050_ss_150.dat')
data3 = np.loadtxt('s_change_kcon_20_070_ss_150.dat')
data4 = np.loadtxt('s_change_kcon_20_090_ss_150.dat')
...
plt.ylabel("Percokation plobability", fontsize = 18)
#plt.ylim(0, 1.1)
#plt.xlim(0, 30)

axe.legend(loc='lower right')
fig.savefig("ss_150.png")
#plt.show()
