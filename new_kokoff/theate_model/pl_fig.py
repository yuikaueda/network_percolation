...
axe.plot(l1, p1, 'o-', c='black', label = r'$N_{best}=80$')#'$k_{on}^{c}=2,k_{off}=0.2$')
axe.plot(l2, p2, 's-', c='red', label = r'$N_{best}=100$')#'$k_{on}^{c}=5,k_{off}=0.2$')
