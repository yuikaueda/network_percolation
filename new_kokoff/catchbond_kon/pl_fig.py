...
data1 = np.loadtxt('f_5e3.dat')
#data2 = np.loadtxt('f_1e3.dat')
...
axe.plot(l1, p1, 'o-', c='black', label = '$k_{on}=0.35exp(0.005N),k_{off}=0.2$')
#axe.plot(l2, p2, 's-', c='red', label = '$k_{on}=0.35exp(0.001N),k_{off}=0.2$')
...
axe.legend()
fig.savefig("p_time30_konf_5e3.png")
#plt.show()
